    ...
    <div className="flex flex-col relative h-screen text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center">
        ...
        <div className='flex flex-col space-y-10 mt-3 xs:px-10'>
            <h4 className='text-3xl xs:text-3xl font-semibold'>
                ...
                <span className='text-xl font-semibold underline decoration-[#88f305]'> Lets Talk</span>
            </h4>

            {/* Mobile Number */}
            <div className='mt-3 flex items-center space-x-5 justify-center'>
                <PhoneIcon className='text-[#88f305] w-7 h-7 animate-pulse'/>
                <p className='text-2xl'>+91 9791091511</p>
            </div>

            {/* Email */}
            <div className='mt-3 flex items-center space-x-5 justify-center'>
                <EnvelopeIcon className='text-[#88f305] w-7 h-7 animate-pulse'/>
            ...
            <div className='flex flex-row text-center justify-between'>
                ...
                <div >
                   <button className='w-[200px] xs:w-[150px] font-semibold  rounded-lg px-5 py-3 bg-[#88f305]/70   '>Make a Call</button>
                </div> 
